...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv4 = nn.Conv2d(in_channels=16,out_channels=32, kernel_size=3,stride=stride_value, padding=padding_value)
        self.bn4 = nn.BatchNorm2d(num_features=32)
        self.pool2 = nn.MaxPool2d(kernel_size=2, stride=2)

        self.conv1_1 = nn.Conv2d(in_channels=32, out_channels=10, kernel_size=1) # 1x1 conv to get 10 channels for 10 classes
